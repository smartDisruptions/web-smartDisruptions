 ...
 * Template 3 — "The Path"
 *
 * A vertical spine, weighted toward the AI arc. The career years are the
 * setup; the three years with LLMs are the substance, because that is the
 * differentiator and the reason anyone lands on this page.
 *
 * The dates are real, taken from Josh's own work history. The AI-era nodes
 * trace a progression rather than a list — prompting, then agents, then
 * pipelines, then memory, then a team — because "I use AI" says nothing and
 * the progression says everything.
 */
const milestones = [
  {
    year: '2007',
