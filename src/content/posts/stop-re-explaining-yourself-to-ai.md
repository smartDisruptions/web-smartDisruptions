...
channels:
  - name: linkedin
    status: done
    note: "Claude remembers things about me between chats now. So does ChatGPT. That's real, and it helps. But it's their memory of me: automatic, out of sight, and it doesn't follow me from one tool to the next.\n\nWhat actually changed how I work was the opposite — a file about myself that I wrote and control.\n\nIt started in Claude Code, which reads a file called CLAUDE.md at the start of every session. Nothing lands in there on its own. I type it, or I tell the AI to save the line. In went how I like to work, what I'm building, and the corrections I was tired of repeating.\n\nLater I got carried away and mapped 34 projects into linked notes. Then I quizzed a completely fresh session about me, like a stranger cramming before a meeting. It answered 6 of 10 questions fully and cited where each answer came from. The 4 it missed were things I'd never written down, and it flagged them as gaps instead of inventing an answer.\n\nThe memory was exactly as good as what I'd fed it.\n\nToday: one plain file. Who you are, what you're working on, what you've shipped, how you like to work. Paste it as your first message.\n\nFull write-up in the first comment."
    comment: "The whole thing — what went in the file, the fresh-session quiz it scored 6 of 10 on, and why a file you write beats the memory a tool keeps for you: https://www.smartdisruptions.com/content/stop-re-explaining-yourself-to-ai"
  - name: substack
    status: planned
    note: "Claude and ChatGPT both keep a memory of me now. That's real, and it helps. It's also theirs — built automatically, out of sight, and it doesn't follow me from one tool to another.\n\nSo I went the other way and wrote the file myself: who I am, what I'm building, how I like to work, sitting in a place my coding tool reads at the start of every session. Nothing lands in it unless I put it there, and that turned out to be the feature rather than the chore.\n\nThe test I ran on it: I quizzed a completely fresh session about me, like a stranger cramming before a meeting. It answered 6 of 10 questions fully and cited its sources. The 4 misses were things I'd simply never written down.\n\nThe memory is exactly as good as what you feed it. The hard part was never the software.\n\nhttps://www.smartdisruptions.com/content/stop-re-explaining-yourself-to-ai"
  - name: x
    status: planned
