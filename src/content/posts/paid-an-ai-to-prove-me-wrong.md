...
channels:
  - name: linkedin
    status: planned
    note: "I ran an AI research pass — five agents with opposed jobs, three rounds each. The output had headings, figures, citations. It read like something a person spent a week on.\n\nThe problem: I had no way to tell a good report from a confident one.\n\nSo I ran a second pass whose only job was to attack the first: one agent per claim, told to treat it as false until a source proved otherwise.\n\nOf eight claims, one survived clean. Seven needed correcting, and the central argument was withdrawn entirely — it rested on something no primary source said, analysts citing each other until it sounded settled.\n\nAlmost nothing came back as a lie. It came back true but wrong in an important way. A figure I'd repeated as one committed number was part commitment, part option. A large \"annual revenue\" number was an annualization; the contracted figure was near zero.\n\nThe numbers were real. What I thought they meant wasn't.\n\nYou can run this with one chat. Open a fresh session that never wrote your thing, paste it in, and say: assume every claim here is false until you find a source that proves it. Then watch for \"true but\".\n\nAsk the session that wrote it and it defends its own work.\n\nFull write-up in the comments."
    comment: "The whole setup is here — the five opposed roles, the four checks every claim had to survive, and why the first report looked completely fine: https://www.smartdisruptions.com/content/paid-an-ai-to-prove-me-wrong"
  - name: substack
    status: planned
    note: "I use AI for real research — several agents, different angles, sources pulled and written up. The output looks great: headings, figures, citations.\n\nThat is exactly the problem. Fluency, structure and citations are the things a language model is best at producing, whether or not the substance holds. So they can't be how I judge it.\n\nSo I ran a second pass whose only job was to attack the first. Of eight claims, one survived clean, seven needed correcting, and the central argument was withdrawn — it existed only in commentary, analysts treating it as established because someone else had.\n\nA claim can be everywhere and sourced nowhere. The check isn't \"can I find this\" — it's \"can I find who first knew it.\"\n\nhttps://www.smartdisruptions.com/content/paid-an-ai-to-prove-me-wrong"
  - name: x
    status: planned
    note: "1/ I ran a proper AI research pass — five agents with deliberately opposed jobs, three rounds each. Headings, figures, citations. It read like a week of human work. Then I ran a second pass whose only job was to attack it. Of eight claims, one survived clean.\n\n2/ Seven needed correcting. The central argument was withdrawn entirely — it turned out to rest on something no primary source actually said. It lived in commentary: analysts referring to each other, each treating it as established because someone else had.\n\n3/ Almost nothing was false. Almost everything was true but wrong in an important way. A figure I'd repeated as one committed number was part commitment, part option. A big \"annual revenue\" number was an annualization; the contracted figure was near zero.\n\n4/ The mistake wasn't a bad source. It was reading a headline and not its footnote. I'd been treating announced and operating as the same word. They are extremely not the same word, and almost every marketing claim lives in that gap.\n\n5/ The framing that made pass two work: the first report's figures went in as claims to attack, not as background. Hand them over as context and it just tidies the first report up. Hand them over as suspects and it can overturn them.\n\n6/ Try it with one chat. Open a fresh session with no memory of writing your thing, paste it in, and say: assume every claim here is false until you find a source that proves it. Ask the session that wrote it and it will defend its own work.\n\n7/ A claim can be everywhere and sourced nowhere. The check isn't \"can I find this\" — it's \"can I find who first knew it.\""
    comment: "Full write-up — the setup, the four checks each claim had to survive, and why the first version looked completely fine: https://www.smartdisruptions.com/content/paid-an-ai-to-prove-me-wrong"
