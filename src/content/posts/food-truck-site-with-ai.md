...
channels:
  - name: linkedin
    status: done
    note: "I built a full online-ordering system for my friend Robert's food truck. Menu, cart, checkout, Square payments. Then I didn't ship it.\n\nWhat went live is a menu with photos and a catering form that sends inquiries straight to his inbox. That's the version he actually uses.\n\nThe receipts, pulled from git history rather than memory:\n\n- About four hours and five commits to a presentable business site, starting from create-next-app.\n- Roughly a day of elapsed time from git init to a working ordering platform with his real menu.\n- The Square payments work landed in six commits in about 21 minutes — after I wrote a design spec, reviewed it, and made an implementation plan first.\n\nThat last one is why I stopped thinking spec-first is slower. It feels slower because you aren't coding yet. The spec is what makes the implementation fast.\n\nThe ordering system still sits in the repo. It works, it's about 80% there, and it's a warm offer for later instead of a cold pitch today.\n\nThe thing to try today: build for one real person, then before you ship, ask which part they'll actually use — and cut the rest.\n\nFull write-up, timeline and method, in the first comment."
    comment: "The whole breakdown is here — the four-hour v1, the 21-minute payments integration, and the six-step method I'd use again: https://www.smartdisruptions.com/content/food-truck-site-with-ai"
  - name: substack
    status: planned
    note: "I built my friend Robert a full online-ordering system for his food truck — menu, cart, checkout, Square payments — and then shipped something much simpler instead: a menu with photos and a catering form that sends inquiries straight to his inbox.\n\nThat's the version he uses. The ordering code is still in the repo. It works, it's about 80% there, and it never shipped.\n\nI keep coming back to that. AI made the building part cheap enough that it almost stopped being the bottleneck. From create-next-app to a presentable site was about four hours. The payments integration came together in six commits in about 21 minutes, because I wrote a spec first instead of freestyling.\n\nNone of that speed helps if you ship the wrong thing. The harder skill is knowing what not to ship.\n\nhttps://www.smartdisruptions.com/content/food-truck-site-with-ai"
  - name: x
    status: planned
    note: "1/ I built my friend Robert a full online-ordering system for his food truck. Menu, cart, checkout, Square payments. Then I didn't ship it. What went live is a menu with photos and a catering form that emails him. That's the version he actually uses.\n\n2/ The receipts, from git history not memory: about four hours and five commits from create-next-app to a presentable business site. Roughly a day of elapsed time total to a working ordering platform with his real menu — an afternoon, plus a few evening sessions.\n\n3/ Payments was the one part I didn't freestyle. Design spec, review the spec, implementation plan, then build. The integration itself landed in six commits in about 21 minutes: the hook, the payment section, tokenization, checkout wiring.\n\n4/ That's why I stopped thinking spec-first is slower. It feels slower because you aren't coding yet. The spec is what makes the implementation fast. So: move fast on normal UI work, slow down on anything that touches money, data, or trust.\n\n5/ Weeks later I pivoted the site to catering and made the menu display-only. The ordering system still sits in the repo — it works, it's about 80% there. Now it's a warm offer for later instead of a cold pitch today.\n\n6/ AI can help you build almost anything now. The harder skill is knowing what not to ship. You don't need to know the framework perfectly. You need to know the person you're building for."
    comment: "Full write-up — the timeline, the payments spec, and the six-step method: https://www.smartdisruptions.com/content/food-truck-site-with-ai"
