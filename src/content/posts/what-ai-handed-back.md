...
heroImageAlt: A card titled 'What only I could do' with three rows — the keys (accounts and credentials), the money (real dollars), and the final yes (the go-live, your name on it).
